...
class EmbeddingService:
    ...
    async def ingest_content(
        ...
        async with AsyncSession(self.engine) as session:
            ...
            # Use generic URI if not in metadata, or just empty
            ...
            # 3. Create Chunk(s)
            # For now, we treat the content as a single chunk (Level 1)
            
            # Get next ord number for this document
            ...
            # Prepare metadata with timestamp if not present
