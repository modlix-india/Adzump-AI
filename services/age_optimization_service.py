...
async def generate_age_optimizations(customer_id: str, login_customer_id: str, campaign_id: str, client_code: str, duration: str ) -> Dict[str, Any]:
    try:
        ...
        metrics = await fetch_age_metrics(customer_id=customer_id, login_customer_id=login_customer_id, access_token=access_token, campaign_id=campaign_id, duration=duration)
