...
class DescriptionGenerator:
    """Generates description optimization suggestions using LLM."""
    ...
    async def generate_suggestions(
        ...
        if similar_assets:
            ...
            examples_text = (
                ...
                f"Create compelling descriptions incorporating these keywords naturally."
            )
            ...
            examples_text = (
                ...
                "Generate general best-practice descriptions that:\n"
                "- Are benefit-oriented and compelling\n"
                "- Communicate clear value propositions\n"
                "- Follow Google Ads best practices\n"
                "- Are informative and persuasive"
            )
            context_note = "General best practices:"

        prompt = prompt_loader.format_prompt(
            "optimization/description_optimization_prompt.txt",
