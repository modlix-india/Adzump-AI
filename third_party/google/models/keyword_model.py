...
class Keyword:
    ...
    def from_google_row(cls, row: dict) -> "Keyword":
        """Map Google Ads API response row to Keyword with basic sanitization."""
        ...
        def clean_str(value: Optional[str]) -> Optional[str]:
            """Ensure clean string values without using magic methods."""
            if not value:
                return None
        ...
        return cls(
            ...
            campaign_name=clean_str(campaign.get("name")),
            ad_group_id=ad_group.get("id"),
            ad_group_name=clean_str(ad_group.get("name")),
            criterion_id=criterion.get("criterionId"),
            status=clean_str(criterion.get("status")),
            keyword=clean_str(keyword_info.get("text")),
            match_type=clean_str(keyword_info.get("matchType")),
